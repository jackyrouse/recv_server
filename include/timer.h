...
timestampTotime_t(const TTimeStamp t)
{
    return double(t - UINT64_C(116444736) * UINT64_C(1000000000)) / 10000000.0;
}

static inline TTimeStamp
timestampAdd(const TTimeStamp tim, const double num_seconds)
{
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
static inline double
timeDifference(const TTimeStamp t1, const TTimeStamp t2)
{
